...
interface UseColumnsProps<RecordType> {
  prefixCls?: string;
...
/**
 * convertChildrenToColumns将传入的节点（来自于父column）转换为column
 * @param children 列的子节点
 */
...
/**
 * revertForRtl将columns每个column的direction进行左右切换
 * @param columns 属性列组
 */
